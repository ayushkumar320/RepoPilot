---
name: "source-command-graph-update"
description: "Run the mandatory Graphify graph update, verify it, stage changed graph files, and emit the GRAPH STATUS block."
---

# source-command-graph-update

Use this skill when the user asks to run the migrated source command `graph-update`.

## Command Template

Perform RepoPilot's mandatory graph-maintenance step (see `AGENTS.md` §4).
