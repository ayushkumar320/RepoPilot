# Graph Report - RepoPilot  (2026-07-09)

## Corpus Check
- 174 files · ~102,876 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1882 nodes · 4705 edges · 123 communities (92 shown, 31 thin omitted)
- Extraction: 63% EXTRACTED · 37% INFERRED · 0% AMBIGUOUS · INFERRED: 1737 edges (avg confidence: 0.54)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6745ead0`
...
Cohesion: 0.14
Nodes (16): AsyncEngine, ChunkHit, RAG Phase 3: ``bm25_search`` SQL composition + param plumbing.  The Postgres FTS, _RecordingEngine, test_blank_query_and_zero_k_short_circuit(), test_clean_query_strips_stopwords_keeps_identifiers(), test_default_sql_uses_simple_analyzer_and_repo_filter(), test_filters_compose() (+8 more)
...
Cohesion: 0.10
Nodes (40): approachability_score(), Lane A — issue triage backed by graph approachability., Score issue approachability from graph facts, not GitHub labels., Rank issues and keep the next three rejected reasons., _ref_for_issue(), run_lane_a_triage(), triage_issues(), detect_quality_opportunities() (+32 more)
...
Cohesion: 0.08
Nodes (53): BaseSettings, CloneResult, EmbeddedChunk, ProviderError, All providers in the fallback chain failed., ModuleSource, AsyncEngine, Settings (+45 more)

### Community 15 - "Community 15"
Cohesion: 0.13
Nodes (31): Any, CodeRef, MonkeyPatch, TourSection, _claim(), engine(), _patch_read_chunks(), Verifier-loop tests: actionability rubric + retry budget + flagging.  The ground (+23 more)
...
Cohesion: 0.12
Nodes (23): Any, index_repo(), arq worker function for the Phase 1 ingestion pipeline.  The actual pipeline log, Build arq RedisSettings from Settings.redis_url.      Without this, arq falls ba, arq job: index a GitHub repo end-to-end. Returns a JSON-able status dict., arq discovery target. Run with: ``arq repopilot_api.jobs.index_repo.WorkerSettin, _redis_settings_from_url(), shutdown() (+15 more)

### Community 20 - "Community 20"
Cohesion: 0.07
Nodes (18): Alembic environment — uses Settings.postgres_dsn so dev + CI agree., Path, Settings, Shared core: settings, logging, and the LLMProvider abstraction., _find_repo_env(), Application settings, loaded from environment / `.env` via pydantic-settings., Walk up from this file to the repo root and return the ``.env`` path.      Lets, Parse a comma-separated env var into a cleaned list. (+10 more)

### Community 22 - "Community 22"
Cohesion: 0.18
Nodes (11): Current Build Phase, How to advance the phase, Pending (does not block the land), Phase 0 facts that feed later phases, Phase 1 — how it landed (httpx), Phase 2 — Query Understanding: DEFERRED (2026-07-08), Phase 3 — how it landed (BM25 hybrid, active), The improvement chain (what each phase fixes, and what it hands the next) (+3 more)
...
Cohesion: 0.28
Nodes (15): ChunkHit, Fuse ranked hit lists into one ranking, best-first.      Each input pool must al, reciprocal_rank_fusion(), _hit(), RAG Phase 3: RRF fusion ordering (``qa/union.py``).  The DB-touching lanes (``bm, test_chunk_found_by_both_lanes_outranks_single_lane(), test_dedup_by_ref_key(), test_dedup_prefers_representative_with_symbol() (+7 more)
...
Cohesion: 0.18
Nodes (20): ChunkContent, Claim, LLMProvider, answer_question(), _Context, _extend_context(), _generate_answer(), _is_not_found() (+12 more)
...
Cohesion: 0.08
Nodes (70): _build_fact_bundle_for_test(), _fact_bundle(), Cartographer — produces ``system_map`` Insights from the call graph.  The Cartog, Run the Cartographer once.      Returns the state diff for the LangGraph reducer, Render the fact bundle as a compact text block.      We deliberately avoid prose, Resolve each symbol's CodeRef from graph_metrics's underlying lookup.      The m, _refs_for_symbols(), _resolve_refs() (+62 more)
...
Cohesion: 0.29
Nodes (6): AsyncEngine, ChunkHit, LLMProvider, hybrid_search(), ``hybrid_search`` — fuse the dense (vector) and sparse (BM25) lanes.  The top of, Return up to ``recall_k`` chunks fused from the dense + sparse lanes.
...
Cohesion: 0.50
Nodes (3): ChunkHit, Reciprocal Rank Fusion (RRF) — fuse multiple ranked ``ChunkHit`` lists.  Used by, _ref_key()
...
Cohesion: 0.08
Nodes (26): Connection, _backoff_delay(), _BaseClient, _cache_key(), _OpenAICompatibleClient, The single LLMProvider every agent goes through.  Responsibilities (Phase 0 deli, Thread-safe SQLite cache keyed on the canonical request hash., Exponential backoff with full jitter. attempt=0 is the first retry. (+18 more)

### Community 76 - "Community 76"
Cohesion: 0.13
Nodes (18): EmbeddingResponse, LLMResponse, Provider-agnostic response shape., Provider-agnostic embedding shape., LLMResponse, Any, EmbeddingResponse, LLMProvider (+10 more)
...
## Knowledge Gaps
- **309 isolated node(s):** `nextConfig`, `name`, `private`, `version`, `type` (+304 more)
...
- **Why does `LLMProvider` connect `Community 34` to `Community 64`, `Community 67`, `Community 39`, `Community 9`, `Community 74`, `Community 75`, `Community 12`, `Community 76`, `Community 14`, `Community 45`, `Community 15`, `Community 19`, `Community 51`, `Community 20`, `Community 28`, `Community 63`, `Community 30`, `Community 31`?**
  _High betweenness centrality (0.109) - this node is a cross-community bridge._
- **Why does `Settings` connect `Community 14` to `Community 34`, `Community 9`, `Community 75`, `Community 76`, `Community 48`, `Community 51`, `Community 20`, `Community 53`, `Community 52`, `Community 19`, `Community 59`, `Community 125`, `Community 30`?**
  _High betweenness centrality (0.092) - this node is a cross-community bridge._
- **Why does `IntentProfile` connect `Community 34` to `Community 64`, `Community 66`, `Community 67`, `Community 39`, `Community 72`, `Community 74`, `Community 11`, `Community 12`, `Community 15`, `Community 25`, `Community 30`, `Community 57`?**
