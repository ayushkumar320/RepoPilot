...
## Corpus Check
- 217 files · ~128,607 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2157 nodes · 5666 edges · 125 communities (104 shown, 21 thin omitted)
- Extraction: 64% EXTRACTED · 36% INFERRED · 0% AMBIGUOUS · INFERRED: 2054 edges (avg confidence: 0.54)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `29df07af`
...
Cohesion: 0.15
Nodes (12): EventDict, Build arq RedisSettings from Settings.redis_url.      Without this, arq falls ba, _redis_settings_from_url(), Any, RedisSettings, configure_logging(), _drop_chunk_content(), Structlog setup: JSON renderer in prod/CI, human-friendly renderer in dev/tests. (+4 more)

### Community 1 - "Community 1"
Cohesion: 0.14
Nodes (32): Any, Any, CodeRef, MonkeyPatch, TourSection, IntentProfile, Free-text intent in, structured tilt out. No fixed purpose enum., _claim() (+24 more)

### Community 2 - "Community 2"
Cohesion: 0.08
Nodes (11): LLMProvider, AccessService, AccountUsage, AllowanceExceededError, InMemoryAccessService, ProductAccessService, Anonymous product sessions, free allowances, and session-only BYOK providers., Raised when a session has no free allowance and no user provider key. (+3 more)
...
Cohesion: 0.11
Nodes (37): approachability_score(), Lane A — issue triage backed by graph approachability., Score issue approachability from graph facts, not GitHub labels., Rank issues and keep the next three rejected reasons., _ref_for_issue(), run_lane_a_triage(), triage_issues(), detect_quality_opportunities() (+29 more)
...
Cohesion: 0.16
Nodes (18): AppServices, Any, FastAPI, create_app(), FastAPI app for the Phase 4 API contract., FastAPI app entrypoint. Endpoints are added in Phase 4., AccountUsageResponse, AskTourRequest (+10 more)
...
Cohesion: 0.08
Nodes (47): ArchaeologistState, Any, AsyncEngine, IntentProfile, LLMProvider, Any, CodeRef, MonkeyPatch (+39 more)

### Community 18 - "Community 18"
Cohesion: 0.14
Nodes (20): Validator tests for ``ArchaeologistState`` and its sub-models.  These tests pin, _ref(), test_claim_defaults_unverified(), test_claim_rejects_relevance_out_of_unit_interval(), test_claim_requires_at_least_one_ref(), test_insight_accepts_complete_fields(), test_insight_rejects_empty_goal_link(), test_insight_rejects_empty_so_what() (+12 more)

### Community 19 - "Community 19"
Cohesion: 0.29
Nodes (31): TourEventType, AsyncEngine, BaseTourEvent, ChunkPayload, CodeRef, GraphQueryResult, IntentProfile, LLMProvider (+23 more)
...
Cohesion: 0.18
Nodes (20): MonkeyPatch, answer_question(), Run the hybrid-retrieval Q&A loop for ``question``.      ``recall_k`` / ``exclud, _patch_tools(), End-to-end Q&A tests against fully stubbed dependencies.  We monkey-patch the th, A claim with no [N] citation must not be pinned to pool[0] and     verified agai, P1 instrumentation: every stage the run touched reports wall-clock., sufficiency/expand run once per hop; their timings must sum, not overwrite. (+12 more)
...
Cohesion: 0.09
Nodes (19): Any, index_repo(), arq worker function for the Phase 1 ingestion pipeline.  The actual pipeline log, arq job: index a GitHub repo end-to-end. Returns a JSON-able status dict., arq discovery target. Run with: ``arq repopilot_api.jobs.index_repo.WorkerSettin, shutdown(), startup(), WorkerSettings (+11 more)
...
Cohesion: 0.12
Nodes (34): ClaimStatus, AsyncEngine, Claim, IntentProfile, LLMProvider, TourSection, CodeRef, Phase2Claim (+26 more)

### Community 30 - "Community 30"
Cohesion: 0.09
Nodes (36): build_opportunity_briefing(), ranker_rationale(), Teacher-facing briefing helpers for Phase 5 opportunity cards., Attach the UI-visible Phase 5 briefing surfaces without reranking., Plain-English explanation of planner-derived ranker weights., lane_c_language_violation(), _matches_focus(), Lane C — guarded structural suspicions. (+28 more)
...
Cohesion: 0.13
Nodes (23): EmbeddedChunk, Chunk, LLMProvider, Settings, AsyncEngine, embed_chunks(), _embed_items(), EmbeddedChunk (+15 more)
...
Cohesion: 0.18
Nodes (14): build_query_spec(), fallback_query_spec(), _infer_intent(), _looks_multi_hop(), _merge_fallback_hints(), _normalize_paths(), _parse_query_spec(), QuerySpec (+6 more)
...
Cohesion: 0.16
Nodes (14): ChunkHit, QuerySpec, Settings, Eval runners for the phase gates., _apply_rerank(), _query_lane_weights(), Pure-retrieval metrics: recall@k, NDCG@k, MRR over a labeled QA dataset.  Runs t, Rerank the pool head; keep the tail in original order so recall@k holds. (+6 more)
...
Cohesion: 0.17
Nodes (16): Path, aggregate(), bench_repo(), main(), Top-level RAG-phase bench runner.  Usage::      uv run python -m repopilot_evals, Stages whose p95 grew most, worst first — the latency culprits.      Returns ``[, Compare ``_after`` to ``_before`` per repo; fail on guardrail breaches.      Gua, Gate sanity check: baseline vs itself must be 'not significant'. (+8 more)

### Community 62 - "Community 62"
Cohesion: 0.12
Nodes (16): CodeRef, CodeRef, mrr(), ndcg_at_k(), 1/0 per ranked hit; each expected ref credits at most one hit., recall_at_k(), ref_matches(), relevance_vector() (+8 more)
...
Cohesion: 0.20
Nodes (14): LLMProvider, _Context, _estimate_tokens(), _extend_context(), _generate_answer(), _initial_retrieval(), _is_not_found(), _query_lane_weights() (+6 more)
...
Cohesion: 0.16
Nodes (17): Chunk, LLMProvider, Message, Settings, Any, Path, Chunk, One indexable unit of source. Line numbers are 1-based, inclusive. (+9 more)
...
Cohesion: 0.08
Nodes (43): BaseModel, _format_paths(), Flow Tracer — produces ``traced_flows`` Insights from call-graph paths.  Reads `, Choose which symbols to trace. Prefer the planner's explicit     targets; otherw, Run the Flow Tracer once.      Returns ``{"traced_flows": [Insight, …]}``. Empty, run_flow_tracer(), _seed_targets(), IntentClass (+35 more)
...
Cohesion: 0.13
Nodes (13): _cache_key(), LLMResponse, ProviderError, In-process embedder using sentence-transformers (Hugging Face weights).      No, Generate a completion. Hits cache first; otherwise walks the fallback chain., All providers in the fallback chain failed., Per-binding 429 retry loop with exponential backoff + jitter., Provider-agnostic response shape. (+5 more)
...
- **Why does `LLMProvider` connect `Community 82` to `Community 0`, `Community 1`, `Community 2`, `Community 6`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 17`, `Community 19`, `Community 23`, `Community 24`, `Community 28`, `Community 29`, `Community 32`, `Community 41`, `Community 45`, `Community 47`, `Community 50`, `Community 53`, `Community 60`, `Community 64`, `Community 71`, `Community 72`, `Community 75`, `Community 76`, `Community 121`?**
  _High betweenness centrality (0.125) - this node is a cross-community bridge._
- **Why does `Settings` connect `Community 10` to `Community 0`, `Community 2`, `Community 9`, `Community 12`, `Community 13`, `Community 19`, `Community 24`, `Community 25`, `Community 27`, `Community 32`, `Community 33`, `Community 34`, `Community 41`, `Community 45`, `Community 50`, `Community 53`, `Community 55`, `Community 57`, `Community 62`, `Community 65`, `Community 67`, `Community 71`, `Community 76`, `Community 82`, `Community 121`?**
  _High betweenness centrality (0.112) - this node is a cross-community bridge._
- **Why does `IntentProfile` connect `Community 1` to `Community 34`, `Community 7`, `Community 72`, `Community 10`, `Community 75`, `Community 43`, `Community 13`, `Community 14`, `Community 15`, `Community 17`, `Community 82`, `Community 19`, `Community 18`, `Community 23`, `Community 29`, `Community 30`?**
