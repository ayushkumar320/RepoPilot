...
_SYSTEM_PROMPT = (
    ...
    "Weights need not sum to 1. Use only the keys listed.\n"
    "  - focus_keywords: array of 1–6 short noun phrases lifted from the "
    "user's statement (lowercase, no punctuation).\n"
    "  - audience_framing: short string describing who the output is for "
    "(e.g. 'for a PR review', 'for internal docs'), or null.\n"
